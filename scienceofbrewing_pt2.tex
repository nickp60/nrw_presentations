...
\begin{frame}\frametitle{Essential Oils}
  ...
  \end{itemize}
  Caryophyllene \includegraphics[width=.15\textwidth]{./brewing/hops/Beta-Caryophyllen-dark.pdf}
  \begin{itemize}
  \item Black pepper, cannabis, caraway, cloves, oregano, cinnamon, rosemary
  \end{itemize}
\end{frame}

\begin{frame}\frametitle{Flavenoids}
  Xanthohumol \includegraphics[width=.5\textwidth]{./brewing/hops/Xanthohumol-dark.pdf}
  \begin{itemize}
  \item Ends up about about 2 μg/L – 1.2 mg/L
    \item most abundant flavenoid in hops
    \item Contributes bitterness and flavor
    \end{itemize}
    8-Prenylnaringenin phytoestrogen \includegraphics[width=.5\textwidth]{./brewing/hops/Xanthohumol-dark.pdf}
\end{frame}
